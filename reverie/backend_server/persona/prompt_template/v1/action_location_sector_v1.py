...
Area options: [Sam's house, The Rose and Crown Pub, Local Cafe, X College, Agent P, Harvey Supply Store, The Willows Market and Pharmacy].
* Stay in the current area if the activity can be done there. Only go out if the activity needs to take place in another place.
* Must be one of the "Area options," verbatim.
For taking a walk, Sam should go to the following area: Agent P
---
Jane lives in [X College Student Dormitory] that has [Jane's room].
Jane is currently in [X College] that has [a classroom, library]
Area options: [X College Student Dormitory, The Rose and Crown Pub, Local Cafe, X College, Agent P, Harvey Supply Store, The Willows Market and Pharmacy].
* Stay in the current area if the activity can be done there. Only go out if the activity needs to take place in another place.
* Must be one of the "Area options," verbatim.
...
def run_gpt_prompt_action_sector(
  ...
  print("🔵 [DEBUG] Action location sector completed successfully")
  return output, [output, prompt, gpt_param, prompt_input, fail_safe]
